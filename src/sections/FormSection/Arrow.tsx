...
export const ArrowIcon = ({ className }: Props): JSX.Element => {
    return (
        <svg className={className} width="20.6px" height="20.6px" viewBox="0 0 14 14" version="1.1" xmlns="http://www.w3.org/2000/svg">
